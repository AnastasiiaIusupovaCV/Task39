 ...
 * @author a.yusupova
 */
public class Task39 extends javax.swing.JFrame {
...
//                this.canvas1.getWidth(), this.canvas1.getHeight());
    ...
    private void jbResizeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbResizeActionPerformed
        ...
        if(currentFig != null)
        {
            ...
            if(currentFig instanceof additionalfigures.IScalable)
    ...
    private void jbStretchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbStretchActionPerformed
        ...
        if(currentFig != null)
        {
            ...
            if(currentFig instanceof additionalfigures.IStretchable)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Task39.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
